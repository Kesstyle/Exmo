...
public class ExmoRestAdapter {
  ...
  private static final Logger LOG = LoggerFactory.getLogger(ExmoRestAdapter.class);
 ...
 public final String get(final String baseUrl, final String operation, final Map<String, String> parameters) {
    ...
    try {
      final String url = baseUrl + operation + URL_SEPARATOR;
      ...
      LOG.debug(String.format("Making a call to %s with parameters %s", baseUrl, parameters));
